...
func ValidateServiceRegistryMessage(msg ServiceRegistryMessage) error {
	if msg == nil {
		return errors.New("aethercore service registry message is required")
	}
...
func (m MsgRegisterService) ValidateBasic() error {
	...
	if descriptor.Owner != m.Authority {
		return errors.New("aethercore service registration authority must match descriptor owner")
	}
	if err := ValidateHash("aethercore service registration owner authorization", m.OwnerAuthorizationHash); err != nil {
		return err
	}
...
func (m MsgUpdateService) ValidateBasic() error {
	...
	if descriptor.Owner != m.Authority {
		return errors.New("aethercore service update authority must match descriptor owner")
	}
	if m.ExpectedVersion == 0 || descriptor.Version < m.ExpectedVersion {
		return errors.New("aethercore service update expected version is invalid")
	}
	return validateRegistryMessageHash(m, m.MessageHash)
}
...
func (m MsgRenewService) ValidateBasic() error {
	...
	if err := validatePolicyID("aethercore service renewal service id", m.ServiceID); err != nil {
		return err
	}
	if m.ExpiryHeight == 0 || m.ExpectedVersion == 0 {
		return errors.New("aethercore service renewal requires expiry height and expected version")
	}
	return validateRegistryMessageHash(m, m.MessageHash)
}
...
func (m MsgDisableService) ValidateBasic() error {
	...
	if err := validatePolicyID("aethercore service disable service id", m.ServiceID); err != nil {
		return err
	}
	if m.ExpectedVersion == 0 {
		return errors.New("aethercore service disable requires expected version")
	}
	if m.Reason != "" {
		if err := validatePolicyID("aethercore service disable reason", m.Reason); err != nil {
			return err
		}
	}
	return validateRegistryMessageHash(m, m.MessageHash)
...
func (m MsgTransferService) ValidateBasic() error {
	...
	if err := validatePolicyID("aethercore service transfer service id", m.ServiceID); err != nil {
		return err
	}
	if err := addressing.ValidateAuthorityAddress("aethercore service transfer new owner", m.NewOwner); err != nil {
		return err
	}
	if m.NewOwner == m.Authority {
		return errors.New("aethercore service transfer new owner must differ")
	}
	if m.ExpectedVersion == 0 {
		return errors.New("aethercore service transfer requires expected version")
	}
	return validateRegistryMessageHash(m, m.MessageHash)
}
...
func (m MsgAnchorServiceReceipt) ValidateBasic() error {
	...
	if m.AnchorHash != "" {
		if err := ValidateHash("aethercore service receipt anchor hash", m.AnchorHash); err != nil {
			return err
		}
	}
	return validateRegistryMessageHash(m, m.MessageHash)
...
func (m MsgSubmitServiceDispute) ValidateBasic() error {
	...
	if err := validatePolicyID("aethercore service dispute service id", m.ServiceID); err != nil {
		return err
	}
	if err := ValidateHash("aethercore service dispute call id", m.CallID); err != nil {
		return err
	}
	if m.ProviderID != "" {
		if err := validatePolicyID("aethercore service dispute provider id", m.ProviderID); err != nil {
			return err
		}
	}
	if err := ValidateHash("aethercore service dispute evidence hash", m.EvidenceHash); err != nil {
		return err
	}
	if err := validatePolicyID("aethercore service dispute reason", m.Reason); err != nil {
		return err
	}
	if m.OpenedHeight == 0 {
		return errors.New("aethercore service dispute opened height must be positive")
	}
	return validateRegistryMessageHash(m, m.MessageHash)
}

func (q QueryPagination) Normalize(params AetherCoreParams) QueryPagination {
	limit := q.Limit
	if limit == 0 {
...
func (q QueryService) Validate() error {
	return validatePolicyID("aethercore query service id", q.ServiceID)
}

func (q QueryServiceByName) Validate() error {
	return validatePolicyID("aethercore query service name", q.ServiceName)
}

func (q QueryServicesByOwner) Validate(params AetherCoreParams) error {
	if err := params.Validate(); err != nil {
		return err
	}
	if err := addressing.ValidateAuthorityAddress("aethercore query services owner", q.Owner); err != nil {
		return err
	}
...
func (q QueryServicesByIdentity) Validate(params AetherCoreParams) error {
	if err := params.Validate(); err != nil {
		return err
	}
	if err := validatePolicyID("aethercore query identity name", q.IdentityName); err != nil {
		return err
	}
	_ = q.Pagination.Normalize(params)
	return nil
...
func (q QueryProvidersByService) Validate(params AetherCoreParams) error {
	if err := params.Validate(); err != nil {
		return err
	}
	if err := validatePolicyID("aethercore query providers service id", q.ServiceID); err != nil {
		return err
	}
	_ = q.Pagination.Normalize(params)
	return nil
...
func (q QueryServiceInterface) Validate() error {
	return ValidateHash("aethercore query service interface hash", q.InterfaceHash)
}

func (q QueryServicePaymentModel) Validate() error {
	return validatePolicyID("aethercore query service payment model service id", q.ServiceID)
}

func (q QueryServiceVerificationModel) Validate() error {
	return validatePolicyID("aethercore query service verification model service id", q.ServiceID)
}

func (q QueryServiceReceipt) Validate() error {
	if err := validatePolicyID("aethercore query service receipt service id", q.ServiceID); err != nil {
		return err
	}
	return ValidateHash("aethercore query service receipt call id", q.CallID)
}

func (q QueryServiceProof) Validate() error {
	return validatePolicyID("aethercore query service proof service id", q.ServiceID)
}
...
func (state ServiceRegistryState) QueryServicesByOwner(q QueryServicesByOwner, params AetherCoreParams) (QueryServicesResponse, error) {
...
func (state ServiceRegistryState) QueryServicesByIdentity(q QueryServicesByIdentity, params AetherCoreParams) (QueryServicesResponse, error) {
	if err := q.Validate(params); err != nil {
		return QueryServicesResponse{}, err
	}
...
func (state ServiceRegistryState) QueryProvidersByService(q QueryProvidersByService, params AetherCoreParams) (QueryProvidersResponse, error) {
	if err := q.Validate(params); err != nil {
...
func QueryServiceParamsResponseFor(params AetherCoreParams) (QueryServiceParamsResponse, error) {
	if err := params.Validate(); err != nil {
...
func ComputeServiceRegistryMessageHash(msg ServiceRegistryMessage) string {
	...
	case MsgRegisterService:
		return hashParts("aetheris-aek-msg-register-service-v1", m.Authority, ComputeServiceDescriptorHash(m.Descriptor), m.OwnerAuthorizationHash)
	case MsgUpdateService:
		return hashParts("aetheris-aek-msg-update-service-v1", m.Authority, ComputeServiceDescriptorHash(m.Descriptor), fmt.Sprint(m.ExpectedVersion))
	case MsgRenewService:
		return hashParts("aetheris-aek-msg-renew-service-v1", m.Authority, m.ServiceID, fmt.Sprint(m.ExpiryHeight), fmt.Sprint(m.ExpectedVersion))
	case MsgDisableService:
		return hashParts("aetheris-aek-msg-disable-service-v1", m.Authority, m.ServiceID, m.Reason, fmt.Sprint(m.ExpectedVersion))
	case MsgTransferService:
		return hashParts("aetheris-aek-msg-transfer-service-v1", m.Authority, m.ServiceID, m.NewOwner, fmt.Sprint(m.ExpectedVersion))
	case MsgBindServiceIdentity:
		return hashParts("aetheris-aek-msg-bind-service-identity-v1", m.Authority, m.ServiceID, m.IdentityName, fmt.Sprint(m.ExpectedVersion))
	case MsgUnbindServiceIdentity:
		return hashParts("aetheris-aek-msg-unbind-service-identity-v1", m.Authority, m.ServiceID, m.IdentityName, fmt.Sprint(m.ExpectedVersion))
	case MsgRegisterProvider:
		return hashParts("aetheris-aek-msg-register-provider-v1", m.Authority, m.ServiceID, m.Provider.ProviderID, m.Provider.ProviderHash)
	case MsgUpdateProvider:
		return hashParts("aetheris-aek-msg-update-provider-v1", m.Authority, m.ServiceID, m.Provider.ProviderID, m.Provider.ProviderHash)
	case MsgStakeProviderCollateral:
		return hashParts("aetheris-aek-msg-stake-provider-collateral-v1", m.Authority, m.ServiceID, m.ProviderID, m.Denom, m.Amount, fmt.Sprint(m.Height))
	case MsgUnstakeProviderCollateral:
		return hashParts("aetheris-aek-msg-unstake-provider-collateral-v1", m.Authority, m.ServiceID, m.ProviderID, m.Denom, m.Amount, fmt.Sprint(m.Height))
	case MsgAnchorServiceReceipt:
		return hashParts("aetheris-aek-msg-anchor-service-receipt-v1", m.Authority, m.Receipt.ServiceID, m.Receipt.CallID, m.Receipt.ReceiptHash, m.AnchorHash)
	case MsgSubmitServiceDispute:
		return hashParts("aetheris-aek-msg-submit-service-dispute-v1", m.Authority, m.ServiceID, m.CallID, m.ProviderID, m.EvidenceHash, m.Reason, fmt.Sprint(m.OpenedHeight))
	default:
		return EmptyRootHash
	}
}
...
func validateRegistryAuthority(authority string) error {
	return addressing.ValidateAuthorityAddress("aethercore service registry message authority", strings.TrimSpace(authority))
}

func validateRegistryMessageHash(msg ServiceRegistryMessage, messageHash string) error {
	if err := ValidateHash("aethercore service registry message hash", messageHash); err != nil {
		return err
	}
	if expected := ComputeServiceRegistryMessageHash(msg); messageHash != expected {
		return fmt.Errorf("aethercore service registry message hash mismatch: expected %s", expected)
	}
	return nil
}
...
func validateServiceIdentityBindingMessage(authority, serviceID, identityName string, expectedVersion uint64, msg ServiceRegistryMessage, messageHash string) error {
	...
	if err := validatePolicyID("aethercore service identity binding service id", serviceID); err != nil {
		return err
	}
	if err := validatePolicyID("aethercore service identity binding identity name", identityName); err != nil {
		return err
	}
	if expectedVersion == 0 {
		return errors.New("aethercore service identity binding requires expected version")
	}
...
func validateProviderMessage(authority, serviceID string, provider FogProviderRecord, msg ServiceRegistryMessage, messageHash string) error {
	...
	if err := validatePolicyID("aethercore service provider message service id", serviceID); err != nil {
		return err
	}
...
func validateProviderCollateralMessage(authority, serviceID, providerID, denom, amount string, height uint64, msg ServiceRegistryMessage, messageHash string) error {
	...
	if err := validatePolicyID("aethercore provider collateral service id", serviceID); err != nil {
		return err
	}
	if err := validatePolicyID("aethercore provider collateral provider id", providerID); err != nil {
		return err
	}
	if err := validatePolicyID("aethercore provider collateral denom", denom); err != nil {
		return err
	}
	if err := validateAmountString("aethercore provider collateral amount", amount); err != nil {
		return err
	}
	if amount == "0" {
		return errors.New("aethercore provider collateral amount must be positive")
	}
	if height == 0 {
		return errors.New("aethercore provider collateral height must be positive")
	}
	return validateRegistryMessageHash(msg, messageHash)
}
...
func (state ServiceRegistryState) serviceProof(serviceID, descriptorHash, interfaceHash string) ServiceRegistryProof {
	...
	recordHash := hashParts("aetheris-aek-service-registry-state-proof-record-v1", key, descriptorHash)
	proof := ServiceRegistryProof{
		ServiceID:      serviceID,
