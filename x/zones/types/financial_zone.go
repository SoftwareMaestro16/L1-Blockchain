...
func BuildFinancialZoneRootFromState(height uint64, state FinancialZoneState, queues ZoneMessageQueues, proofRoot string) (ZoneRoot, error) {
	...
	roots := FinancialZoneRoots{
		...
		PaymentRoot:        ComputeFinancialPaymentRoot(normalized.PaymentChannels, normalized.PaymentConditions),
...
func ComputeFinancialZoneStateRoot(state FinancialZoneState) string {
	...
	return hashRuntimeParts(
		...
		ComputeFinancialPaymentRoot(normalized.PaymentChannels, normalized.PaymentConditions),
	)
}
...
func ComputeFinancialPaymentRoot(channels []FinancialPaymentChannel, conditions []FinancialPaymentCondition) string {
